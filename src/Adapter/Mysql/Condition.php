...
namespace Janfish\Database\Criteria\Adapter\Mysql;
...
class Condition
{
    ...
    public function generate()
    {
        ...
        return [
            implode($this->_where, ' ' . self::AND_OPERATOR_CHAR . ' '),
            $this->_bind,
        ];
    }
    ...
    public function where($field, $value)
    {
        ...
        return $whereSql ? implode(' ' . self::AND_OPERATOR_CHAR . ' ', $whereSql) : '';
    }
